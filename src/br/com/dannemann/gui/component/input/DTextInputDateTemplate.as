 ...
 *
 */
public class DTextInputDateTemplate extends TextInput
{
    //--------------------------------------------------------------------------
    //
    //  Constructor
     ...
     *  Constructor.
     */
	public function DTextInputDateTemplate()
	{
		super();
	...
	public function set inputMask(s:String) : void
	{
		...
		switch(_inputMask)
		{
			...
			case "YYYY/DD/MM" : _inputMask = "####//##//##";
								...
								dateField = true;
								break;
			case "DD/MM/YYYY HH:MM" : _inputMask = "##//##//#### ##:##";
								embedStr = "DD MM YYYY HH MM";
								dateField = true;
								break;
			default: break;
		}
	...
	private function interceptChar( event:TextEvent ) : void
	{
		...
		if( _position >= actualLength ) {
			...
			if(_autoAdvance && !isWorkingIncomplete())
			{
				...
				if((obj is DTextInputDateTemplate) || (obj is TextInput) || (obj is TextArea))
					obj.setFocus();
			}
	...
	override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
	{
    	...
    	if(dateField)
    	{
	    	...
	    	const txtFormat:TextFormat = new TextFormat();
	    	txtFormat.color = enabled ? getStyle("backgroundColor") : getStyle("backgroundDisabledColor");
